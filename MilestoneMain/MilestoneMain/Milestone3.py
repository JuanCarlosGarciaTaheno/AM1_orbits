...
def test_error_convergence():
    ...
    Error, U = error_evaluation(t, Kepler, Euler, order, U0)
    ...
    Error, U = error_evaluation(t, Kepler, Inverse_Euler, order, U0)
    ...
    Error, U = error_evaluation(t, Kepler, Crank_Nicolson, order, U0)
    ...
    Error, U = error_evaluation(t, Kepler, RK4, order, U0)
...
def test_temporal_convergence_rate():
    N = 2000 # si lo bajo mas se distorsiona una grafica
    t = linspace(0, 10, N)
    U0 = array([1, 0, 0, 1])
    m = 5
    # busco el plot de la convergencia -- los log
    print("Tasa de Convergencia - Euler")
    order, log_e, log_n = temporal_convergence_rate(t, Kepler, U0, Euler, m)
    ...
    order, log_e, log_n = temporal_convergence_rate(t, Kepler, U0, Inverse_Euler, m)
    ...
    order, log_e, log_n = temporal_convergence_rate(t, Kepler, U0, Crank_Nicolson, m)
    ...
    order, log_e, log_n = temporal_convergence_rate(t, Kepler, U0, RK4, m)
